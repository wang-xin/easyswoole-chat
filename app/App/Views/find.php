        ...
        <div class="layui-tab-content">
                            ...
                            <div class="layui-card">
                                ...
                                <div class="layui-card-body">
                                    <img style="width: 75px;height: 75px;object-fit: cover;"
                                         src="<?= $this->e($v['avatar']) ?>" alt="">
                                    <button onclick="addFriend(<?= $this->e($v['id']) ?>,'<?= $this->e($v['nickname']) ?>','<?= $this->e($v['avatar']) ?>')"
            ...
            <div class="layui-tab-item  <?php if ($type == 'group'): ?>layui-show<?php endif; ?>  ">
                ...
                <?php foreach ($group_list as $k => $v): ?>
                    ...
                    <div class="layui-col-md4" style="border-bottom: 1px solid #f6f6f6">
                        <div class="layui-card">
                            <div class="layui-card-header"> <?= $this->e($v['groupname']) ?>(<?= $this->e($v['id']) ?>
                                )
                            </div>
                            <div class="layui-card-body">
                                <img style="width: 75px;height: 75px;object-fit: cover;"
                                     src="<?= $this->e($v['avatar']) ?>" alt="">
                                <button onclick="joinGroup(<?= $this->e($v['id']) ?>)" style="float: right"
