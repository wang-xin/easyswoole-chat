...
<ul class="layui-nav">
    <li class="layui-nav-item" style="float: right;">
        <a href="javascript:;"><img src="<?= $this->e($user['avatar']) ?>"
                                    class="layui-nav-img"><?= $this->e($user['username']) ?></a>
        <dl class="layui-nav-child">
            <dd><a href="/Index/logout?token=<?= $this->e($token) ?>">退出登录</a></dd>
        </dl>
    </li>
